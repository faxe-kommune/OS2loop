 ...
 */
function os2_loop_compact_preprocess_page(&$variables) {
  global $user;
  $arg = arg();
  if ($user->uid > 0) {
 ...
 */
function os2_loop_compact_preprocess_node(&$variables) {
  // Fetch node author.
 ...
 */
function os2_loop_compact_preprocess_block(&$variables) {
  // Skip login formular.
 ...
 */
function os2_loop_compact_preprocess_panels_pane(&$variables) {
  if (arg(0) == 'editor') {
  ...
  if ($variables['pane']->subtype == 'user_messages-panel_pane_1' || $variables['pane']->subtype == 'user_messages-panel_pane_5') {
    ...
    $variables['message_count'] = _os2_loop_compact_fetch_user_new_notifications();
 ...
 */
function os2_loop_compact_preprocess_search_api_page_results(&$variables) {
 ...
 */
function os2_loop_compact_menu_local_task($variables) {
  $secondary = '';
 ...
 */
function os2_loop_compact_menu_local_tasks($variables) {
  $output = '';
...
function os2_loop_compact_menu_tree__main_menu($variables) {
  ...
  if (_os2_loop_compact_print_notification_tab()) {
    $variables['tree'] = _os2_loop_compact_print_notification_tab() . $variables['tree'];
  }
 ...
 * Forms the header menu together with main menu.
 */
function os2_loop_compact_menu_tree__management($variables) {
  return $variables['tree'];
}
 ...
 * inside.
 */
function os2_loop_compact_fieldset($variables) {
  $element = $variables['element'];
 ...
 */
function os2_loop_compact_panels_default_style_render_region($vars) {
  $output = '';
 ...
 */
function os2_loop_compact_form_user_login_alter(&$form) {
 ...
 */
function os2_loop_compact_form_user_register_form_alter(&$form) {
 ...
 * field.
 */
function os2_loop_compact_form_search_api_page_search_form_default_alter(&$form) {
 ...
 */
function os2_loop_compact_form_user_profile_form_alter(&$form) {
 ...
 */
function os2_loop_compact_form_notifications_account_manage_subscriptions_form_alter(&$form) {
  // Hide filtering.
 ...
 */
function os2_loop_compact_theme($existing, $type, $theme, $path) {
  return array(
 ...
 */
function os2_loop_compact_preprocess_comment(&$variables) {
 ...
 */
function os2_loop_compact_textarea($variables) {
  $element = $variables['element'];
 ...
 * overrides).
 */
function os2_loop_compact_preprocess_views_view(&$vars) {
 ...
 */
function _os2_loop_compact_fetch_full_name ($user) {
  $name = '';
 ...
 */
function _os2_loop_compact_fetch_user_new_notifications() {
 ...
 */
function _os2_loop_compact_fetch_author_image($author) {
  $author_image = '';
 ...
 *   Comment safe value.
 */
function _os2_loop_compact_fetch_comment_body($comment) {
  // Load entity wrapper.
 ...
 */
function _os2_loop_compact_fetch_files($type, $entity) {
  $files = FALSE;
