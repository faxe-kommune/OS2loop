...
just by suffixing default CSS values (plus unit) in a code comment. These are
...
#### Note ####
Do not to set the values of several CSS
properties simultaneously if targeted with code comments.
Instead of:
...
/**
 * The CSS values that are suffixed with '/*variable' comments are intended for use
